...
namespace APIBasedPluginTests\Unit\Container;

use DI\Container;
use DI\Definition\Exception\InvalidDefinition;
use Psr\Container\NotFoundExceptionInterface;
use PHPUnit\Framework\TestCase;
use APIBasedPluginTests\Unit\Container\Fixtures\Outer;
use APIBasedPluginTests\Unit\Container\Fixtures\Middle;
use APIBasedPluginTests\Unit\Container\Fixtures\Inner;
use APIBasedPluginTests\Unit\Container\Fixtures\ScalarWithArrayAndDefault;
use APIBasedPluginTests\Unit\Container\Fixtures\ScalarWithOutDefault;
